...
export default class AppPage extends PageView {
	...
	onBeforeActivate(...args) {
		super.onBeforeActivate(...args);
		if (this.options.showBarShadow) {
			context.tabs && context.tabs.showBarShadow();
		} else {
			context.tabs && context.tabs.hideBarShadow();
		}
	}
